...
[Click here for a 3D plot demonstrating memory in the listening chains.](/images/spotify/skpdn.html) This clearly shows a positive association between danceability of the current song and the preferred danceability of the next song. Furthermore, if the danceability of the current song is low, a low danceability is highly preferred in the next song, which makes sense.
