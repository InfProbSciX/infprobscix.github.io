...
As $$WW_i - \mathbb{1}$$ appears to be normal, $$Q$$ can be computed using a Schur decomposition (where we use a square root of the central diagonal matrix to get to $$Q$$).
