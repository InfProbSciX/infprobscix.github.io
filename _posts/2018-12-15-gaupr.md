...
GPs can represent functions and perhaps function spaces well (by having a covariance interpretation and also a basis function interpretation I guess). By contrast, a neural network can't fit functions as easily - it needs _a lot more_ data.
