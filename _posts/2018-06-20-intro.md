...
$$ \mathbb E_p \left( ln \; p(Y) \right) - \mathbb E_p \left( ln \; p_{\mathcal M} (Y) \right) = \mathbb E_p \left( ln \; \frac{p(Y)}{p_{\mathcal M} (Y)} \right) = - \mathbb E_p \left( ln \; \frac{p_{\mathcal M} (Y)}{p(Y)} \right) $$

$$ \overset{Jensen}{\geq} - ln \; \mathbb E_p = - \; ln \int \frac{p_{\mathcal M}}{p} dp = - \; ln \int p_{\mathcal M} dy = - \;ln\; 1  = 0 \tag* {$\blacksquare$} $$
...
<center> <img src="/images/intro_e.png"> </center>
...
(Discussion needs to be added here, this is super interesting:)
