...
> "Statistical inference is concerned with drawing conclusions, from numerical data, about quantities that are not observed." <sup> [1, pg. 4] </sup>
...
Inference can be _parametric_ (i.e. involving numbers representing explanations or summaries called _parameters_ that let you throw away some part / all of the data) or _non-parametric_ (i.e. inference involving methods where you cannot discard data).
